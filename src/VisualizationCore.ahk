...
CreateYellowBorderBitmap(width, height) {
    ...
    bitmap := 0
    DllCall("gdiplus\GdipCreateBitmapFromScan0", "Int", width, "Int", height, "Int", 0, "Int", 0x26200A, "Ptr", 0, "Ptr*", &bitmap)
    ...
    ; Draw yellow border
    yellowBrush := 0
    DllCall("gdiplus\GdipCreateSolidFill", "UInt", 0xFFFFFF00, "Ptr*", &yellowBrush)  ; Yellow

    ; Top
    DllCall("gdiplus\GdipFillRectangle", "Ptr", graphics, "Ptr", yellowBrush, "Float", 0, "Float", 0, "Float", width, "Float", 2)
    ; Bottom
    DllCall("gdiplus\GdipFillRectangle", "Ptr", graphics, "Ptr", yellowBrush, "Float", 0, "Float", height-2, "Float", width, "Float", 2)
    ; Left
    DllCall("gdiplus\GdipFillRectangle", "Ptr", graphics, "Ptr", yellowBrush, "Float", 0, "Float", 0, "Float", 2, "Float", height)
    ; Right
    DllCall("gdiplus\GdipFillRectangle", "Ptr", graphics, "Ptr", yellowBrush, "Float", width-2, "Float", 0, "Float", 2, "Float", height)

    DllCall("gdiplus\GdipDeleteBrush", "Ptr", yellowBrush)

    ; Create HBITMAP
    hbitmap := 0
    DllCall("gdiplus\GdipCreateHBITMAPFromBitmap", "Ptr", bitmap, "Ptr*", &hbitmap, "UInt", 0x00000000)  ; Transparent background
