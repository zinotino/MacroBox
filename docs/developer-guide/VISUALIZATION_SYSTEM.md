...
- **Dual-Tier Architecture**: HBITMAP (primary), PNG (fallback)
...
- **Color Consistency**: Synchronized degradation colors across visualization systems
...
### Dual-Layer Visualization Stack
...
#### CSV Statistics Display
- Same color mapping used in AutoHotkey GUI
- Consistent visual representation across all displays
- Color-coded degradation type identification
...
3. Compare colors with statistics display
