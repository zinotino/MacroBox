...
- Automatic degradation state tracking
...
### ✓ Category Management
- Customizable degradation types/categories
...
│       ├── color.ahk          # Degradation color mapping
│       └── logging.ahk        # Debug output helpers
├── resources/
│   ├── colors.ini             # Color scheme (RGB codes)
│   └── degradation_types.ini  # Category definitions
└── build/
...
### Customizing Categories/Degradation Types

**File**: `resources/degradation_types.ini`

```ini
[Categories]
# Format: categoryId=categoryName|colorHex|description

1=Defect Type A|0xFF00FF00|Minor surface scratches
2=Defect Type B|0xFFFF0000|Deep cracks
3=Defect Type C|0xFF0000FF|Discoloration
4=Defect Type D|0xFFFFFF00|Edge damage
```
...
2. **Select Category**
   - Press: `F2` to cycle through degradation types
   - Current category shows in status (e.g., "Category: Defect Type A")
